# Setup Guide: pipx Install

This guide walks you through everything you need to get the project running on
your Mac, ending with a `pipx` install and a run by hand.
...
| Disk space | ~3 GB free (model weights) |

> **Note:** M1 with 8 GB works. Inference takes well under a minute per chart.
...
| LLM | SmolVLM2 500M (local, via Hugging Face) |
...
The model weights (~2 GB) are downloaded automatically on first run and cached at:
